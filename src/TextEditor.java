...
public class TextEditor extends JFrame implements ActionListener,
    ...
    public TextEditor() {
        ...
        JButton SaveButton = new JButton(new ImageIcon("C:\\Users\\Gharib\\eclipse-workspace\\TextEditor\\save.png"));
        SaveButton.setName("SaveButton");
        panel.add(SaveButton);

        JButton LoadButton = new JButton(new ImageIcon("C:\\Users\\Gharib\\eclipse-workspace\\TextEditor\\load.png"));
